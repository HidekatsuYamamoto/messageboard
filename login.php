...
<li class="last"><a href="index.php">書き込み <span class="en">Write</span></a></li>
<li class="active"><a href="session_check.php">ログ確認 <span class="en">Log</span></a></li>
</ul>
...
<!-- Input Field -->    
<h1 class="pageTitle">ログインが必要です。</h1>
<form method="post" action="after_login.php" enctype="multipart/form-data" >
    <div class="section emphasis">
        <div class="inner">
            <dl>
                <dt>■ログインID</dt>
                <dd><input type="text" name="inputted_ID" size="30" /></dd>
            </dl>
            <dl>
                <dt>■パスワード</dt>
                <dd><input type="password" name="inputted_password" size="60" value="********"/></dd>
            </dl>
...
<p class="form"><a href="mailto:xxxxx@xxx.xx-net.net.jp?subject=問い合わせ&amp;body=ご記入ください">メールはこちらへ</a></p>
